...
const generateEmailTemplate = (fullName, otp, purpose) => {
  ...
  <div style="margin:50px auto;width:70%;padding:20px 0">
    ...
    <p>Thank you for choosing Lang App. Use the following OTP to complete your ${purpose} procedures. OTP is valid for 5 minutes</p>
    <h2 style="background: #00466a;margin: 0 auto;width: max-content;padding: 0 10px;color: #fff;border-radius: 4px;">${otp}</h2>
    <p style="font-size:0.9em;">Regards,<br />Lang App Development Team</p>
